...
THREE.CSS3DRenderer = function() {
  ...
  this.render = function(scene, camera) {
    ...
    const fov = 0.5 / Math.tan(THREE.Math.degToRad(camera.fov * 0.5)) * _height
    ...
    const objects = _projector.projectScene(scene, camera, false).objects

    let style = 'translate3d(0,0,' + fov + 'px)' + getCameraCSSMatrix(camera.matrixWorldInverse) + ' translate3d(' + _widthHalf + 'px,' + _heightHalf + 'px, 0)'
